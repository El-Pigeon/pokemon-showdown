...
//Custom Pokemon
	amplet: {	
		...
		name: "Amplet",
		types: ["Water", "Electric"],
		baseStats: {hp: 50, atk: 65, def: 45, spa: 40, spd: 45, spe: 80},
		abilities: {0: "Lightning Rod", 1: "Swift Swim", H: "Volt Absorb"},
		heightm: 0.1,
		weightkg: 0.4,
		color: "Green",
		evos: ["Sparklin"],
	...
	sparklin: {
	    ...
	    baseForme: "Normal",
		types: ["Water", "Electric"],
		baseStats: {hp: 100, atk: 130, def: 75, spa: 60, spd: 75, spe: 110},
		abilities: {0: "Lightning Rod", 1: "Swift Swim", H: "Amped"},
		heightm: 3.0,
		weightkg: 50,
		color: "Green",
		prevo: "Amplet",
		evoLevel: 45,
		eggGroups: ["Monster", "Water 1"],
	    otherFormes: ["Sparklin-Amped"],
		formeOrder: ["Sparklin", "Sparklin-Amped"],
		gen: 7,
	},
	sparklinamped: {	
		num: -100,
